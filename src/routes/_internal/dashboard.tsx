...
import { ChartBarLabel } from 'src/components/chart-bar-label';
import { ChartPieDonutText } from 'src/components/chart-pie-donut-text';
...
export const Route = createFileRoute('/_internal/dashboard')({
    ...
    beforeLoad: ({ context }) => {
        if (
            ...
            !Can(context.auth.currentUser.role, 'view_dashboard')
        ) {
