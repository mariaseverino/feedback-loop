...
import SendFeedback from 'src/components/send-feedback';
import FeedbackList from 'src/components/feedback-list';

export const Route = createFileRoute('/_internal/feedback')({
