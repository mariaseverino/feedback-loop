...
import { ResumeStep } from 'src/components/resume-step';
import type { RegistrationData } from 'src/types/auth';
import { RegistrationDataStep } from 'src/components/registration-data-step';
